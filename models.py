...
def build_model(model_name: str, num_classes: int, pretrained: bool = True) -> nn.Module:
    ...
    # -------------------------------------------------------------
        ...
        # Dynamically fetch default weights
        weight_attr = f"{model_name_clean.capitalize()}_Weights"
        weights_class = getattr(models, weight_attr, None)
        weights = weights_class.DEFAULT if (weights_class and pretrained) else None
